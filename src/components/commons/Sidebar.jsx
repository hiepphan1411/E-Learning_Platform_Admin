...
const SIDEBAR_ITEMS = [
	...
	{ name: "Certificates", icon: ShoppingCart, color: "#F59E0B", href: "/certificates" },
			...
			<div className='h-full bg-gray-800 bg-opacity-50 backdrop-blur-md p-4 flex flex-col border-r'>
				...
				<nav className='mt-8 flex-grow'>
					{SIDEBAR_ITEMS.map((item) => (
						<Link key={item.href} to={item.href} onClick={() => setTitle(item.name)}>
